...
크레딧 충전은 마이탭 → 크레딧 충전에서 이용 가능합니다.`,
  ...
  {
    slug: "launch-signup-5000-credits",
    category: "event",
    title: "런칭 기념 — 가입 시 5,000 크레딧 지급",
    published_on: "2026-05-26",
    sort_order: 600,
    show_new_dot: true,
    body: `연운이 정식 오픈했습니다.

런칭을 기념하여 신규 가입 시 5,000 크레딧(5,000원 상당)을 드립니다.
카드 등록 없이, 음성 상담·점사에 바로 사용할 수 있습니다.

[혜택 내용]
- 가입 시 5,000 크레딧 1회 지급 (가입 후 30일 이내 사용)
- 비로그인 방문 시 기기당 3분 음성 체험 1회
- 카드 등록 불필요
- 4명 안내자 모두 선택 가능
