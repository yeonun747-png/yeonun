  ...
  return (
    <div className="y-admin-fortune-menu-editor">
      ...
      <p className="y-admin-fortune-menu-hint">
        소메뉴마다 제목·해석 프롬프트·이미지·동영상(mp4) 썸네일을 넣을 수 있습니다. 파일을 드래그 앤 드롭하면 Supabase 스토리지에 올라가고 URL이 채워집니다(같은 슬롯에 다시 올리면 기존 파일은 교체 삭제). 메뉴를 지운 뒤 스토리지까지 비우려면 URL 칸 아래「스토리지에서 파일 삭제」를 누른 다음 상품을 저장하세요. 프론트 점사 목차는 소메뉴 기준입니다.
      </p>
      {menus.length === 0 ? (
